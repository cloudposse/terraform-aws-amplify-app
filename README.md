...
| <a name="input_iam_compute_role_arn"></a> [iam\_compute\_role\_arn](#input\_iam\_compute\_role\_arn) | The AWS Identity and Access Management (IAM) compute role for the Amplify app. | `string` | `null` | no |
